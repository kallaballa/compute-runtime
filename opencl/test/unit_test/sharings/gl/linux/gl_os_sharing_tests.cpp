...
//#include "shared/source/os_interface/linux/wddm/wddm.h"
//#include "shared/source/os_interface/linux/wddm_memory_operations_handler.h"
#include "shared/test/common/helpers/engine_descriptor_helper.h"
#include "shared/test/common/mocks/mock_execution_environment.h"
//#include "shared/test/common/os_interface/linux/wddm_fixture.h"
...
//#include "opencl/test/unit_test/os_interface/linux/mock_sys_calls.h"
...
TEST(glSharingBasicTest, GivenSharingFunctionsWhenItIsConstructedThenBackupContextIsCreated) {
    GLType GLHDCType = CL_EGL_HDC_KHR;
    ...
    EXPECT_EQ(1, dllHelper.getParam("EGLCreateContextCalled"));
    EXPECT_EQ(1, dllHelper.getParam("EGLShareListsCalled"));
    ...
    EXPECT_EQ(1, dllHelper.getParam("EGLDeleteContextCalled"));
