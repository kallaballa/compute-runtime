...
TEST(glSharingBasicTest, givenGlSharingFunctionsWhenItIsConstructedThenFunctionsAreLoaded) {
    ...
    EXPECT_NE(nullptr, glSharingFunctions.pfnEglCreateContext);
    EXPECT_NE(nullptr, glSharingFunctions.pfnEglDeleteContext);
    EXPECT_NE(nullptr, glSharingFunctions.pfnEglShareLists);
    EXPECT_NE(nullptr, glSharingFunctions.eglMakeCurrent);
...
TEST(glSharingContextSwitch, givenSharingFunctionsWhenGlDeleteContextIsNotPresentThenItIsNotCalled) {
    auto glSharingFunctions = new GLSharingFunctionsLinux();
...
TEST_F(glSharingTests, givenUnknownBaseEventWhenGetGlArbSyncEventIsCalledThenNullptrIsReturned) {
    auto *sharing = context.getSharing<GLSharingFunctionsLinux>();
