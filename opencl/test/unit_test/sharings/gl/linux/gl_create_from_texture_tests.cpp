...
TEST_F(CreateFromGlTextureTests, DISABLED_GivenGlTextureTargetAndMipLevelNegativeWhenCreateIsCalledThenMipMappedImageIsCreated) {
...
TEST_F(CreateFromGlTextureTests, DISABLED_GivenGlTextureTargetAndMipLevelNonNegativeWhenCreateIsCalledThenImageFromChosenMipLevelIsCreated) {
    unsigned int target = GL_TEXTURE_3D;
    cl_GLint miplevel = 2;
...
TEST_F(CreateFromGlTextureTests, DISABLED_GivenGlTextureWhenCreateIsCalledThenAllocationTypeIsSharedImage) {
    unsigned int target = GL_TEXTURE_3D;
    cl_GLint miplevel = 2;
