...
TEST_F(GlSharingTextureTests, DISABLED_givenMockGlWhenRenderBufferTextureIsCreatedThenMemObjectHasGlHandler) {
    cl_int retVal = CL_INVALID_VALUE;
...
TEST_F(GlSharingTextureTests, DISABLED_givenDifferentHwFormatWhenSurfaceFormatInfoIsSetThenOverwrite) {
    cl_int retVal = CL_INVALID_VALUE;
...
TEST_F(GlSharingTextureTests, DISABLED_givenGLRGB10FormatWhenSharedGlTextureIsCreatedThenItHasCorrectGenxSurfaceFormatAssigned) {
    cl_int retVal = CL_INVALID_VALUE;
...
TEST_F(GlSharingTextureTests, DISABLED_givenContextAndRenderBufferTextureWhenClCreateFromGlTextureIsCalledThenImageIsReturned) {
    cl_int retVal = CL_INVALID_GL_OBJECT;
...
TEST_F(GlSharingTextureTests, DISABLED_givenContextWithoutSharingAndRenderBufferTextureWhenClCreateFromGlTextureIsCalledThenErrorIsReturned) {
    tempMM->useForcedGmm = false;
    clContext->resetSharingFunctions(CLGL_SHARING);
    cl_int retVal = CL_INVALID_GL_OBJECT;
    auto glImage = clCreateFromGLRenderbuffer(clContext.get(), 0, textureId, &retVal);
...
TEST_F(GlSharingTextureTests, DISABLED_givenHwCommandQueueAndGlTextureWhenItIsCreatedWithClCreateFromGlTexture1dThenImageObjectIsReturned) {
    auto retVal = CL_SUCCESS;
    auto glImage = clCreateFromGLTexture2D(clContext.get(), 0, GL_TEXTURE_1D, 0, textureId, &retVal);
    ASSERT_EQ(CL_SUCCESS, retVal);
    ASSERT_NE(nullptr, glImage);
...
TEST_F(GlSharingTextureTests, DISABLED_givenContextWithoutSharingAndGlTextureWhenItIsCreatedWithClCreateFromGlTexture2dThenErrorIsReturned) {
    tempMM->useForcedGmm = false;
    clContext->resetSharingFunctions(CLGL_SHARING);
    auto retVal = CL_SUCCESS;
...
TEST_F(GlSharingTextureTests, DISABLED_GivenGlTextureThenBufferOffsetIsCorrect) {
    glSharing->uploadDataToTextureInfo(textureId);
...
TEST_F(GlSharingTextureTests, DISABLED_givenHwCommandQueueAndGlRenderBufferWhenAcquireIsCalledThenAcquireCountIsIncremented) {
    glSharing->uploadDataToTextureInfo(textureId);
...
TEST_F(GlSharingTextureTests, DISABLED_givenSharedGlTextureWhenItIsAcquireCountIsDecrementedToZeroThenCallReleaseFunction) {
...
TEST_F(GlSharingTextureTests, DISABLED_givenSharedRenderBufferWhenItIsAcquireCountIsDecrementedToZeroThenCallReleaseFunction) {
...
TEST_F(GlSharingTextureTests, DISABLED_givenMultisampleTextureWithMoreThanOneSampleWhenAskedForNumSamplesThenReturnCorrectValue) {
...
TEST_F(GlSharingTextureTests, DISABLED_givenTextureWithOneSampleWhenAskedForNumSamplesThenReturnZero) {
...
TEST_F(GlSharingTextureTests, DISABLED_givenTextureWithZeroSamplesWhenAskedForNumSamplesThenReturnZero) {
...
TEST_F(GlSharingTextureTests, DISABLED_givenMockGlWhenGlTextureIsCreatedFromFormatNotIncludedInSurfaceFormatsThenErrorAndNoTextureIsReturned) {
...
TEST_F(GlSharingTextureTests, DISABLED_givenMockGlWhenGlTextureIsCreatedWithUnifiedAuxSurfThenMapAuxGpuVaIsCalled) {
...
TEST_F(GlSharingTextureTests, DISABLED_givenAuxDisabledAndUnifiedAuxCapableWhenGlTextureIsCreatedThenAllocationIsTreatedAsUncompressed) {
    CL_GL_RESOURCE_INFO textureInfoToReturn = {};
